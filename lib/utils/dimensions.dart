...
class Dimensions {
  ...
  static double bottomHeightBar = screenHeight / 10.55;
  ...
  static double width35 = screenWidth / 24.1;
  static double width45 = screenWidth / 18.11;
  ...
  static double iconSize16 = screenHeight / 52.1;
